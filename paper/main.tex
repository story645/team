...
\begin{table}[H]
  ...
  \begin{tabular}{|r|l|}
    \hline
    merge & equation & behavior\\
    \hline
    indices  & $\dbasec_{a} \sqcup_{\dbasec_c} \dbasec_b$ & ${\dbasepoint \in \dbase_a, \dbase_b$ | $\dbasepoint_c \in \dbase_a, \dbase_b$ for all $dbase_ \in \dbasec$ \\
    \hline
    fields  & $\dfiberc_{a} \times_{\dfiberc_c} \dbase_c$
    \hline

  \caption{}
  \label{tab:appendix:summary:merge}
  }
\end{table}
