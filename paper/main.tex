...
\mathcal{\gbasec}^{op} \arrow[rr, "\sheafc_{\vindex_*}(\dtotalc)", bend left] \arrow[rr, "\sheafc_{\vartistc}(\gtotalc)"', bend right] &  & \bm{Set}\\
    & {} &                            
\end{tikzcd}
\end{equation}
...
\begin{equation}
  ...
  \vartist: \sheafc_{vindex_*}(\dtotal) \rightarrow \sheafc_{\vartist}(\gtotal)
\end{equation}
