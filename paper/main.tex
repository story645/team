...
Because the artist is a functor of sheaves, the artist preserves the inclusion and restriction conditions of a presheaf \autoref{def:atct:presheaf} and the locality and gluing conditions of a sheaf \autoref{def:atct:sheaf} when mapping between subspaces $\vindex(\opensetg) \rightarrow \openset$. This bookkeeping is necessary for any visualization technique that selectively acts on different pieces of a data set; for example streaming visualizations \cite{krstajicVisualizationStreamingData2013} and panning and zooming \cite{NekrasovskiEvaluationPanZoom2006}
