...
The set of sets of sections $\{\Gamma(\opensetg, \gtotal)\}\vert_{{\opensetg \in gbase}}$ is subcategory of \textbf{Set}; therefore the full space of graphics is a sheaf $\sheaf(\gtotal)$
...
\begin{equation}
  ...
  \begin{tikzcd}[column sep=tiny, row sep=huge]
    ...
    \bigm{\vert} \vartist(\dsectionc) = \gsectionc \textcolor{set} \;, \dsectionc \in \sheafc(\dtotalc){\big\}} 
