...
\begin{equation}
  ...
  \end{tikzcd}
\end{equation}
The equivariance condition expressed in \label{eq:artist:equivariance} is that a graphic generated by  transforming and then visualizing data $\vartist(\dfunc_{\dtotal}(\sheaf_{\mathcal{dtotal}}))$ can equivalently be generated by visualizing the data and then transforming the graphic $\dfunc_{\vartist}(\vartist(\sheaf_{\mathcal{\dtotal}}))$. This expectation of equivariance is illustrated in \autoref{fig:related-work:equivariance}
