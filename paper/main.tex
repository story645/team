...
\end{definition}
\note{intuition about fiber + spivak} 
...
\end{equation*}
 ...
 \begin{definition} A functor is a morphism between any two  categories $\bm{F}: \mathcal{C} \rightarrow \mathcal{D}$. A functor has the properties of identity and composition \cite{riehlCategoryTheoryContext}\end{definition}
...
Over these open sets $\openset_i$ are sets of local sections 
