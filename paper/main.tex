...
E-mail: haizenman@.edu, mgrossberg@ccny.cuny.edu
...
Computer science data types roughly describe structure in an equivalent manner;
objects are elements of the set and class operators and methods are akin to
actions, as described in \autoref{sec:atct:fb:fiber}. Given this equivalancy between code and math, we can develop software functions to test whether structure is preserved based on mathematical tests of structure preservation. For example, \textit{equivariance} allows us to test stucture preservation under transformations to data or visualization and has been proposed by Kindlemann and Scheidegger\cite{kindlmannAlgebraicProcessVisualization2014} and \textit{homomorphism} provides a way of asserting whether the relations between data elements was preserved as proposed by Mackinlay\cite{mackinlayAutomaticDesignGraphical1987}.
