...
\begin{equation}
  ...
  \begin{tikzcd}[column sep=small]
    {\Gamma(U_1, \dtotalc)}                                       & {}                                                    & {\Gamma(U_2, \dtotalc)} \arrow[ll, "\iota^*"', hook'] \\
                                                                  &                                                       &                                                       \\
    U_1 \arrow[uu, "\sheafc_{\dtotal}"] \arrow[rr, "\iota"', hook] & {} \arrow[uu, "\sheafc_{\dtotal}" description, dotted] & U_2 \arrow[uu, "\sheafc_\dtotal"']                    
    \end{tikzcd}
\end{equation}
...
\begin{equation}
  \vartistc: \sheafc_{\dtotalc} \rightarrow \sheafc_{\vartistc}
