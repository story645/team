...
\section{Algebraic Topology And Category Theory}
...
\begin{equation}
  ...
  \begin{split}
  \cgamma{\opensetc}{\dtotalc} \coloneqq & \{\dsectionc^{0} \cdots \dsectionc^{i} \cdots \dsectionc^{n}\} 
  & \dsectionc: \opensetc\rightarrow \dtotalc
  \end{split}
\end{equation}
