...
\end{tikzcd}
\end{equation}
The objects of \textbf{Set} in this sheaf are the sets of sections $\Gamma(\dbase, \dtotal)$ introduced in \autoref{eq:related-work:continuity:sections} and the morphisms are the inclusion maps $(\iota, \iota^*)$ introduced in \autoref{eq:related-work:continuity:presheaf}. As mentioned in \autoref{re} sections $\dsection$ are 


\note{add transition sentence about artist }

The continuity of the graphic is encapsulated as a category $\mathcal{\gbase}}$ 
...
As with $\mathcal{\dbase}$, the morphisms between the open sets  $\opensetg$ are inclusion morphisms $\iota$. Over the graphic space $\opensetg \subseteq \gbase$ are a set of sections 
\begin{equation}
