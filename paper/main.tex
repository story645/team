...
\begin{table}[h!]
  ...
  \begin{tabular}{|r r r r r|}
     ...
     & \textcolor{base}{base space} & \textcolor{base}{openset} & \textcolor{fiber}{field types} & \textcolor{total}{total space}
  \end{tabular}
  \caption{Topological spaces introduced in \autoref{sec:atct:fiber-bundles} and \autoref{sec:construction:vtotal}}
