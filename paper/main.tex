...
\begin{definition} The category $\textcolor{section}{\mathcal{T}}$ consists of 
  ...
  \begin{itemize}
  \item \textit{object} the set of sections $\Gamma(U, \dtotal)$ where $U$ can be any object in $\mathcal{\dbase}$
  \item \textit{morphisms} restrictions \note{\iota which we will use in (6) so 7 is cleanly abstracted}
  \end{itemize}
\end{definition}
