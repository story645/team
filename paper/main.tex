...
\begin{equation}
  ...
  \begin{tikzcd}
    F_a\times{_{F_c}}F_b     & F_a \arrow[d, "proj_a"] \\
    F_b \arrow[r, "proj_b"'] & F_c                    
    \end{tikzcd}
\end{equation}
...
\begin{tikzcd}
 ...
 & \dfiberc_c &                                          &  &\\
  \dfiberc_b \arrow[rr, "\vchannelc^{\prime}"] \arrow[ru, "proj_b" description] &            & \vfiber_b \arrow[rr, "\vmarkd^{\prime}"] &  & Im_{\vmarkdc^{\prime}}\subset \gtotalc^{\prime} \arrow[lllu, "g_b" description, dashed]
  \end{tikzcd}
\end{equation}
