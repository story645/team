...
\begin{table}[h!]
  ...
  \begin{tabular}{|r | c c c|}
    ...
    \hline
   Data & $\dbasepoint \in \opensetc \subseteq \dbasec$ & \dfiberc & \dtotalc\\
   Visual & $\dbasepoint \in \opensetc \subseteq \dbasec$  & \vfiberc & \vtotalc\\
...
\begin{table}[h!]
  ...
  \begin{tabular}{|r | l l | }
    \hline
     ...
     & location to record &  subset to set of possible records  \\
     \hline
...
data for \gbasepointc & $\vindexpullc\dsectionc: \opensetgc \rightarrow  \vindexpullc\dtotalc\restriction_{\opensetgc}$ & $\vindexpullc\dsectionc(\gbasepointc)=\dsectionc(\vindexc(\gbasepointc)) = \dsectionc(\dbasepointc)  \\
\hline
  \end{tabular}
