...
\begin{table}[H]
  \begin{equation*}
    ...
    \begin{tikzcd}[ampersand replacement=\&, sep=huge]
      ...
      \textcolor{base}{C} \arrow[u, "\delementc"', dashed, bend right, color=fiber]
      \end{tikzcd}
    &
    \begin{tikzcd}[ampersand replacement=\&, sep=huge]
    ...
    \end{equation*}
    \caption{}
    \label{tab:fiber_specification}
  \end{table}

Building on Spivak, we define the \textcolor{fiber}{fiber space} \dfiberc\ to be the space of all possible data records:
\begin{equation}
