...
\note{Functionl, Types, What is viz library architecture}
\section{Related Work}
Many visualization researchers have discussed structure preservation in a visualization context. In this work, we build on and generalize the notion that the structure of a dataset can be described as a combination of the topological properties of the dataset and the mathematical structure of the dataset fields.
