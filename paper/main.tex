...
The domain of the artist function is the space of all possible graphics. We model this space using categories that are analogous to the data categories


We model the space of all possible graphics as a sheaf $\sheafc_{\mathcal{H}}:\mathcal{S} \rightarrow \mathcal{H}$


The graphic category $\mathcal{\gtotalc}$ is analogous to the $\
