...
In this work, we propose that equivariance constraints can be expressed using category theory. Vickers et. al provide a brief introduction to category theory for visualization practitioners \cite{vickersUnderstandingVisualizationFormal2013}, but their work focuses on visualization deisgn, while this paper aims to provide guidance on designing visualization library components. 
\begin{definition} A category is a 
\end{definition}
