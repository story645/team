...
\section{Summary}
This table contains a summary of the topological structures introduced in \autoref{sec:atct:fiber-bundles} and \autoref{sec:construction:vtotal} and what they encode. These structures serve as the basis of abstractions for the data objects in \autoref{sec:discussion}. 

\begin{table}[h]
  \centering
  \begin{tabular}{|r|r|r|r|r|}
    \hline
   & Data  & Visual  & Graphic  & Encodes \\
\hline 
\textcolor{total}{total space} & \dtotal & \vtotal & \gtotal &  \\
\hline
\textcolor{base}{base space} & \dbase & \dbase & \gbase & topological structure\\
\hline 
\textcolor{base}{open set} & \openset & \openset & \opensetg & subspace \\
\hline 
\textcolor{fiber}{fiber space} & \dfiber & \vfiber & \gfiber  & field structure\\
\hline 
\textcolor{section}{Section} & \dsection & \vsection & \gsection & data set \\
\hline
  \end{tabular}
\end{table}

This table contains a summary of the functions introduced in \autoref{sec:atct:xi}, \autoref{sec:artist}, and \autoref{sec:construction}. These functions are an abstraction of the behavior implemented in visualization libraries.
...
\begin{tabular}{|r|l|r|r|}
  ...
  \hline
  \textcolor{artist}{artist} & $\vartist: \Gamma(\dbase, \dtotal) \rightarrow \Gamma(\gbase, \gtotal)$ &  data & graphic \\
  \hline 
  \textcolor{functor}{lookup} & $\vindex: \gbase\rightarrow \dbase$ & graphic space & data space\\
  \hline
  \multicolumn{4}{c}{}\\
  \hline
  \textcolor{artist}{encoder} & $\vchannel: \Gamma(\dbase, \dtotal) \rightarrow \Gamma(\dbase, \vtotal) $ & data & visial \\
  \hline
  \textcolor{artist}{compositor} & $\vmark: \Gamma(\dbase,\vtotal) \rightarrow \Gamma(\gbase, \vtotal)$ & visual & graphic \\
  \hline
\end{tabular}
\end{table}
