        ...
        \begin{equation*}
            ...
            \begin{tikzcd}[ampersand replacement=\&, row sep=huge]
              ...
              \onslide*<4-|handout:1->{\arrow[d, "\pi"']} \\
               ...
               \onslide*<7|handout:3>{\arrow[u, "\gsectionc \in \cgamma{\opensetgc}{\gtotalc\restriction_{\opensetgc}}"', bend right, pos=.5]}
            \end{tikzcd}
        \end{equation*}
...
\begin{comment}
    \note{move this to top where I introduce data/graphics}
...
\begin{frame}{Remapping Components}
    \begin{block}<>{Functor $\vchannel$}
        $\vchannelc$ is a functor from on fiber categories $\vchannel: \mathcal{\dfiberc} \rightarrow \mathcal{\vfiberc}$  
...
\begin{frame}{implement}
    ...
    \cgamma{\opensetc}{\vtotalc\restriction_{\opensetc}} 
    \arrow[r, "\vmarkc_*"] 
    \arrow[rr, "\vmarkc", bend left] \& 
    \cgamma{\opensetc}{\gtotalc\restriction_{\opensetc}} \& 
    \cgamma{\opensetgc}{\gtotalc\restriction_{\opensetgc}} 
    \arrow[l, "\vindexcpush"]\\ 
    \& \\ \& 
    \opensetc 
    \arrow[luu, "{\sheafc_{\dbasec, \dtotalc}}" description, maps to] 
    \arrow[uu, "{\sheafc_{\dbasec, \vtotalc}}" description, maps to] 
    \arrow[ruu, "{\sheafc_{\dbasec, \gtotalc}}" description, maps to] 
    \& \& 
    \opensetgc \arrow[uu, "{\sheafc_{\gbasec, \gtotalc}}" description, maps to] 
    \arrow[ll, "\vindexc"', dashed]
    \end{tikzcd}
\end{frame}
