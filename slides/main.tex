...
\begin{frame}
    ...
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&, row sep=huge]
            \onslide*<7-8|handout:4>{\sheafc_{\gbasec, \gtotalc}} 
            ...
            \onslide*<7-8,10-|handout:4>{\arrow[u, "\sheaf_{\gbasec, \gtotalc}", maps to, color=sheaf]}
    ...
    \only<7|handout:4>{
        \begin{itemize}
            ...
            \item $\gsectionc(\gbasepointc) = \{d_0, \cdots,\}, \dbasepointc \in \opensetfc$
        \end{itemize}
    }
