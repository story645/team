...
\begin{frame}<presentation:1-|handout:1->
    ...
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&]
          \onslide*<0|handout:1>{\sheafc_{\gbasec, \g
          totalc}} 
...
\begin{frame}<presentation:1|handout:1>{$\dfuncc = (\dfunchc, \dfunctc)$}
    \begin{tikzcd}[ampersand replacement = \&]
        ...
        \arrow[uu, "{\sheafc_{\dbasec, \dfuncpullc\dtotalc}}"', maps to, color=sheaf] 
        \arrow[rruu, "{\sheafc_{\dbasec, \dfuncpullc\dtotalc}}"', maps to, color=sheaf] 
        \&  \& 
    \end{tikzcd}
    \begin{description}
        ...
        \item [Fiber Transformation:]{$\dfunctc: \dfuncpullc \dtotalc_{\dbasepointc^{\prime}} \rightarrow {\dfuncpullc\dtotalc_{\dbasepointc^{\prime}}} \in Hom(\dfuncpullc\dfiberc\restriction_{\dbasepointc}, \dfuncpullclllllll\dfiberc\restriction_{\dbasepointc}), \dbasepointc^{\prime} \in \opensetc^{\prime}$\\
...
\begin{frame}<presentation:1|handout:1->
    ...
    \onslide*<presentation:1|handout:1>{
        \begin{equation*}
            \prod\limits_{i=0}^{n} \underbrace{Hom(\dbasec,\dtotalc_i)}_{\dsectionc_i} = 
            \underbrace{Hom(\dbasec,  \prod\limits_{i=0}^{n}\dtotalc_i)}_{\dsectionc}
        \end{equation*}}
    \onslide*<presentation:2|handout:2>{
    \begin{equation*}
        \prod\limits_{i=0}^{n} \underbrace{Hom(\dfunchc\dbasec, \dfunctc_i\dfuncpullc \dtotalc_i)}_{\dfuncc_i\dsectionc_i} = 
        \underbrace{Hom(\dfunchc\dbasec,  \prod\limits_{i=0}^{n} \dfunctc_i\dfuncpullc\dtotalc_i)}_{\dfuncc\dsectionc}
    \end{equation*}}
...
\begin{frame}<presentation:0|handout:->{Visual Measurement}
    \begin{columns}
    \column{.5\textwidth}
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&]
    ...
    \end{equation*}
    \column{.5\textwidth}
    \onslide*<presentation:0|handout:2>{
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&]
            \measurec 
            \arrow[rr, "\dfunctc_{\measurec}", color=action] 
    ...
    \end{columns}
    \onslide*<presentation:0|handout:1>{
