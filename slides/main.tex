...
\begin{frame}{Visualizations are structure preserving maps}
    \begin{description}
        ...
        \item [equivariance] data transformations have an equivalent effect on the graphical representation, e.g. rotating a matrix has a matching rotation of the image, translating the points on a line has a matching visual shift in the line plot
      \end{description}
\end{frame}
...
\begin{frame}{Expressed in Indexing}
    \begin{figure}
...
\begin{frame}{Why is indexing not enough?}
    \includegraphics[width=1\linewidth]{../paper/figures/whycontinuity.png}
\end{frame}

\begin{frame}{Fiber bundle as abstract data structure\cite{butlerVectorBundleClassesForm1992,butlerVisualizationModelBased1989}}
\begin{columns}
    \column{0.49\columnwidth}
        \begin{equation}
...
\begin{frame}{Equivariance}
    \begin{description}
        \item[Retinal Variables \& Marks] visual encodings match properties of the data \cite{bertinSemiologyGraphicsDiagrams2011a}
        \pause
