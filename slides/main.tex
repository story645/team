...
\only<8|handout:8>{pullback \& pushforward}
...
\only<10|handout:10>{pushforward sections}
    ...
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&, row sep=huge]
            ...
            \onslide*<10-|handout:10->{\{\gsectionc: \gbasepointc \textcolor{section}{\rightarrow} \setc \}}
            \onslide*<7-8|handout:7-8>{\arrow[rr, "\textcolor{functor}{\vindexpush}", color=functor]} \& \& 
            ...
            \onslide*<7-8|handout:7-8>{\arrow[u, "\sheaf_{\gbasec}", color=sheaf]}
            ...
            \onslide*<7-8|handout:7-8>{\arrow[u, dashed, color=sheaf]} \\
            \onslide*<5-6,8|handout:5-6,8>{(\textcolor{functor}{\vindexpull}\sheafc_{\dbasec})(\gbasec)} 
            \onslide*<9,11-|handout:9,11->{\{\textcolor{functor}{\vindexpull}\dsectionc:\gbasepointc\textcolor{section}{\rightarrow}\setc\}}
            ...
            \onslide*<9,11-|handout:9,11->{\{\dsectionc: \dbasepointc \textcolor{section}{\rightarrow} \setc \}}
        \end{tikzcd}
    \end{equation*}
\end{frame}


\begin{frame}{\only<1-3:handout:1-3>{Pullback \& Pushforward are Isomorphic}\only<4-|handout:4>{Data to Graphic is a Sheaf Morphism}}
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&]
          \onslide*<1-|handout:1->{\sheafc_{\gbasec}(\gbasec)} 
          ...
          \& \& 
          \onslide*<1-|handout:1->{(\textcolor{functor}{\vindexpush}\sheafc_{\gbasec})(\dbase)} \\
          \& \& \\
          \onslide*<1-|handout:1->{(\textcolor{functor}{\vindexpull}\sheafc_{\dbase})(\gbasec)}
          ...
          \&  \& 
          \onslide*<1-|handout:1->{\sheafc_{\dbase}(\dbase)} 
