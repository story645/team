...
\begin{frame}<presentation:1|handout:1>{Equivariant Artist}
    \begin{equation*}
        ...
        \end{tikzcd}
    \end{equation*}
        $(\vartistc, \vartistc^{\prime})$ are equivariant with respect to $\dfuncc_{\dtotalc}$ if a compatible transform  $\dfuncc_{\dtotalc}$ can be defined such that 
        \begin{equation*}
...
\begin{frame}<presentation:1|handout:1>{Testing if \vartistc\ is equivariant}
    ...
    \arrow[lldd, "\measure"] \\
    \& \& \& \&  \\
    {Hom(\opensetc, \measure )} 
    \&  \& 
    {Hom(\opensetgc,\measure )} 
...
\begin{frame}<presentation:0|handout:1->{Visual Measurement}
    \begin{columns}
    \column{.5\textwidth}
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&]
            \measurec 
            \arrow[rr, "\dfuncc_{\measurec}", color=action] 
            \& \& 
            \measurec^{\prime}\\
            \& \& \\
            \opensetgc 
...
\begin{frame}<presentation:1|handout:1->
    ...
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&]
            ...
            \onslide*<presentation:0|handout:2>{\arrow[rrr, "\equivc", bend left, color=monoid, dashed]} \&  \& 
            \cgamma{\opensetgc}{\gtotalc\restriction_{\opensetgc}} 
            \arrow[d, "\dfuncc_{\gtotalc}"', color=action]
            \onslide*<presentation:0|handout:1>{\arrow[r, "\delta"]}
            \onslide*<presentation:0|handout:2>{\arrow[r,"\delta \circ \vindexprec"]}
            \& 
            ...
            \cgamma{\opensetc^{\prime}}{\dtotalc^{\prime}\restriction_{\opensetc^{\prime}}} 
            \arrow[rr, "\vartistc", Rightarrow, color=artist] 
            \onslide*<presentation:0|handout:2>{\arrow[rrr, "\equivc"', bend right, color=monoid, dashed]} \&  \& 
            \cgamma{\opensetgc^{\prime}}{\gtotalc^{\prime}\restriction_{\opensetgc^{\prime}}} 
            \onslide*<presentation:0|handout:1>{\arrow[r, "\delta"]}
            \onslide*<presentation:0|handout:2>{\arrow[r,"\delta \circ \vindexprec"]} \& 
