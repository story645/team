...
\begin{frame}{Natural Transformation $\textcolor{nattran}{\alpha}: \textcolor{functor}{F} \textcolor{nattran}{\mapsto} \textcolor{functor}{G}$}

    \adjustbox{scale=3, center}{
        \begin{tikzcd}[ampersand replacement=\&]
            \& {} \arrow[dd, "\alpha" , maps to, shorten=1.5em, color=nattran] \&             \\
...
\begin{frame}
    \frametitle<1-2|handout:1>{Data Space: $\vartistc_{\vindexpushc}: \sheafc_{\dbasec, \dtotalc} \textcolor{artist}{\mapsto} \vindexpushc\sheafc_{\gbasec, \gtotalc}$}
    \frametitle<3-4|handout:2>{Display Space: $\vartist_{\vindexpullc}: \vindexpullc\sheafc_{\dbasec, \dtotalc} \rightarrow \sheafc_{\gbasec, \gtotalc}$}
    ...
    \onslide*<1|handout:1>{
      ...
      \begin{tikzcd}[ampersand replacement =\&]
        ...
        \arrow[rrrr, "\vartistc_{\opensetc_1}", bend left, color=artist, maps to] \&  \& 
        \opensetc_1 
        ...
        \arrow[dd, "\iota^*", hook', color=set] \\
        {} 
        \arrow[rrrr, dotted, color=artist, maps to] \&\&\&\& {} \\
        \cgamma{\opensetc_2}{\dtotalc} 
        \arrow[rrrr, "\vartistc_{\opensetc_2}"', bend right, color=artist, maps to] \&  \& 
        \opensetc_2 
        \arrow[ll, "\sheafc_{\dtotalc}"', color=sheaf, maps to] 
        \arrow[rr, "\sheafc_{\gtotalpushc}", color=sheaf, maps to] 
  ...
  \begin{tikzcd}[ampersand replacement =\&]
    ...
    \arrow[dd, "\iota^*"', hook, color=set] 
    \arrow[rrrr, "\vartistc_{\opensetgc_1}", bend left, color=artist, maps to] \&  \& 
    \opensetgc_1 
    ...
    \arrow[rrrr, "\vartistc_{\opensetgc_2}"', bend right, color=artist, maps to] \&  \& 
    \opensetgc_2 
    \arrow[ll, "\sheafc_{\dtotalpullc}"', color=sheaf, maps to] 
    \arrow[rr, "\sheafc_{\gtotalc}", color=sheaf, maps to] 
    \arrow[uu, "\iota" description, hook, color=base] \& \& 
