...
\begin{frame}{Data Transformation \dfuncc?}
...
\begin{frame}{Field Equivariance}
    ...
    \begin{tikzcd}[ampersand replacement=\&]
            \cgamma{\opensetc}{\dtotalc\restriction_{\opensetc}} 
            \arrow[rr, "\vartistc", Rightarrow, color=artist] 
            \arrow[dd, "\dfuncc_{\dtotalc}"', color=action] 
            \arrow[rrrr, "\equivc", bend left, color=monoid] \&  \& 
            \cgamma{\opensetgc}{\gtotalc\restriction_{\opensetgc}} 
            \arrow[rr, "L", ]                               \&  \& 
            M 
            \arrow[dd, "\dfuncc_{M}", dashed, color=action] \\
            \& \& \& \& \\
            \cgamma{\opensetc^{\prime}}{\dfuncpullc\dtotalc\restriction_{\opensetc^{\prime}}} 
            \arrow[rr, "\vartistc"', Rightarrow, color=artist] 
            \arrow[rrrr, "\equivc"', bend right, color=monoid]   \&  \& 
