...
\begin{frame}{"Valid" viz?}
    \begin{equation*}
        ...
        \begin{tikzcd}[ampersand replacement = \&, column sep=tiny, row sep=huge]
            ...
            \&  \& 
            \onslide*<2-|handout:1>{\textcolor{set}{\big\{}\gsectionc 
              \bigm{\vert} \delta(\vartistc(\dfuncc_{\dtotalc}(\dsectionc))) = \dfuncc_{M}(\delta(\gsectionc)) \textcolor{set}{\big\}}} 
...
\begin{frame}{Functor $\vchannelc: \dfiberc \rightarrow \vfiberc$}
    \begin{equation*}
        \begin{tikzcd}[ampersand replacement=\&]
            \dfiberc 
            \arrow[rr, "\vchannelc_{\dfiberc,\vfiber}"] 
            \arrow[rrdd, "{\vchannelc_{\dfiberc,{\vfiberc}^{\prime}}"', dotted] 
            \&  \& 
            \vfiberc \coloneqq \dfiberc^{\prime}  
            \arrow[dd, "\vchannelc_{{\dfiberc}^{\prime}, {\vfiberc}^{\prime}}"] \\
            \&  \& \\
            \&  \& \vfiberc^{\prime}                           
        \end{tikzcd}
    \end{equation*}
    \begin{alertblock}
        $\vchannelc$ is a functor s.t. if there exists a map ${\vchannelc}_{\dfiber, \vfiber}: \dfiber \mapsto \vfiber$ and 
        ${\vchannelc}_{{\dfiber}^{\prime}, {\vfiber}^{\prime}}: {\dfiber}^{\prime} \mapsto {\vfiber}^{\prime}$ then by composition there exists a map ${\vchannelc}_{\dfiberc, {\vfiberc}^{\prime}}: \dfiberc \rightarrow {\vfiberc}^{\prime}$
    \end{alertblock}
\end{frame}
...
\begin{frame}{Equivariant Data to Components: $\vchannel: \sheaf_{\dbasec,\dtotalc} \rightarrow \sheaf_{\dbasec, \vtotalc}$}
    ...
    implement $\vchannelc$ as a functor such that 
        \begin{description}
...
\begin{frame}{Combining Components}
    \begin{tikzcd}[ampersand replacement = \&]
    \cgamma{\opensetc}{\dtotalc\restriction_{\opensetc}} 
    \arrow[r, "\vchannelc", color=artist] \& 
    \cgamma{\opensetc}{\vtotalc\restriction_{\opensetc}} 
    \arrow[r, "\vmarkc_*", color=artist] 
    \arrow[rr, "\vmarkc", bend left, color=artist] \& 
    \cgamma{\opensetc}{\vindexpushc\gtotalc\restriction_{\opensetc}} \& 
    \cgamma{\opensetgc}{\gtotalc\restriction_{\opensetgc}} 
    \arrow[l, "\vindexpushc"', color=functor, dashed]\\ 
    \& \\ \& 
    \opensetc 
    ...
    \arrow[ruu, "{\sheafc_{\dbasec, \gtotalc}}" description, maps to, color=sheaf] 
    \& \& 
    \opensetgc 
    \arrow[uu, "{\sheafc_{\gbasec, \gtotalc}}" description, maps to, color=sheaf] 
    \arrow[ll, "\vindexc"', dashed, color=functor]
    \end{tikzcd}
