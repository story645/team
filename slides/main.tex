...
\begin{frame}
    ...
    \only<6|handout:2>{
        ...
        \only<7|handout:3>{
            \begin{description}[style=nextline]
                \item[\textcolor{total}{Graphic \gtotalc}]{virtual rendered output}
                \item[\textcolor{base}{Continuity \gbasec}]{topology of graphic in rendered space}
                \item[\textcolor{fiber}{Display \gfiberc}] {generalization of renderer specifications, e.g. \{xy,rgba\}, \{xy, cymk\}, \{xyz, rgba\}}
            \end{description}
            }
    \end{columns}
    \pause 
