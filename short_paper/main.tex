...
\begin{figure}[!h]
    ...
    \caption{The transposition of the Dirichlet distribution is preserved in the visualization because the Artist implements presheaf constraints and the binning of the Dirichlet data is preserved in the visualization because the artist is equivariant.}\label{fig:artist}
\end{figure}
